class ProjectList
  ...
  def project_list
    ...
    @project_list = [
      { a: 1 }.merge(app_settings.for_project(:club_membership_web))
    ]
    # { a: 0 }.merge(app_settings.for_project(:club_membership_react)),
    # { a: 0 }.merge(app_settings.for_project(:club_membership_react_native))
