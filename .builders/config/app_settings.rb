class AppSettings
  ...
  def init
    ...
    settings = base.merge({
      name:                          :club_membership_web,
      project_type_xxx:              :mvc,
      project_type:                  :web,
      project_variant:               :entity_framework,
      app_type:                      'MVC App',
      application:                   project,
      application_lib_path:          project,
      application_namespaces:        ['ClubMembership', 'Web'],
  ...
  def base
    ...
    @base = begin
      value = {
        ...
        main_story:                    'As Club President, I want to manage my members, so that I can grow my club',
        author:                        'David Cruwys',
        author_email:                  'david@ideasmen.com.au',
        copyright_date:                '2021',
        website:                       'http://appydave.com/csharp/samples/club_membership',
        application_lib_path:          'P11ClubMembership',
        application_namespaces:        ['P11ClubMembership'],
        template_rel_path:             'csharp-mvc',
        app_path:                      '~/dev/csharp/P11ClubMembership',
        data_path:                     '_/.data'
      }
